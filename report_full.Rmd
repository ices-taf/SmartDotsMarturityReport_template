...
output:
  word_document:
    ...
    fig_height: 10
    fig_width: 10
    reference_docx: bootstrap/basic_files/reportTemplate.docx
    toc: true
    keep_md: false
params:
  report_title: ""
...
summary_multiple_modes_sex_all <-
  c(NSample  = length(unique(ad_long_all$FishID)),
    ...
    PercMM_negexp_weight=unique(ifelse(multimode_cases_tab_negexp_Sex_all$NModes_negexp=="zero", paste(0,"%"), paste(round((nrow(multimode_cases_tab_negexpweight_Sex_all)/length(unique(ad_long_all$SampleID)))*100, digits=0),"%"))),
...
summary_multiple_modes_maturity_all <-
  c(NSample  = length(unique(ad_long_all$FishID)),
    ...
    PercMM_negexp_weight=unique(ifelse(multimode_cases_tab_negexp_Maturity_all$NModes_negexp=="zero", paste(0,"%"), paste(round((nrow(multimode_cases_tab_negexpweight_Maturity_all)/length(unique(ad_long_all$SampleID)))*100, digits=0),"%"))),
...
summary_multiple_modes_sex_ex <-
  c(NSample  = length(unique(ad_long_ex$FishID)),
    ...
    PercMM_negexp_weight=unique(ifelse(multimode_cases_tab_negexp_Sex_ex$NModes_negexp=="zero", paste(0,"%"), paste(round((nrow(multimode_cases_tab_negexpweight_Sex_ex)/length(unique(ad_long_ex$SampleID)))*100, digits=0),"%"))),
...
summary_multiple_modes_maturity_ex <-
  c(NSample  = length(unique(ad_long_ex$FishID)),
    ...
    PercMM_negexp_weight=unique(ifelse(multimode_cases_tab_negexp_Maturity_ex$NModes_negexp=="zero", paste(0,"%"), paste(round((nrow(multimode_cases_tab_negexpweight_Maturity_ex)/length(unique(ad_long_ex$SampleID)))*100, digits=0),"%"))),
