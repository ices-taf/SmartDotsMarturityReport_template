...
data_mat<-data_overview_tab_maturity[,c(-4,-6,-7,-8)]

# Output table
#pander(style_table0(get(vname("data_overview_tab_maturity"))), missing="-", style = "simple")
pander(style_table0(get(vname("data_mat"))), missing="-", style = "simple")
```
...
data_sex<-data_overview_tab_sex[,c(-4,-6,-7,-8)]
# Output table
#pander(style_table0(get(vname("data_sex"))), missing="-", style = "simple")
