...
output:
  word_document:
    ...
    fig_height: 10
    fig_width: 10
    reference_docx: bootstrap/basic_files/summaryTemplate.docx
    toc: false
    keep_md: false
params:
  summary_title: ""
...
# Table caption
set.caption(paste('**Table X:** Overview of the number of samples (num) by length category used for the exchange event number ', event_number, ". The range of maturity stages (mat_stages), modal maturity stages (modal_mat_stages), sex categories (sex_cat) and modal sex categories (modal_sex_cat) for those individuals within the length range are also presented.", sep=""))
...
# Output table
pander(style_table0(sex_composition_tab_ex), missing = "-", style = "simple")
...
# Output table
pander(style_table0(maturity_composition_tab_ex), missing = "-", style = "simple")
...
# Output table
pander(style_table1(cu_tab_sex_ex), missing = "-")
...
# Output table
pander(style_table1(cu_tab_maturity_ex), missing = "-")
...
# Output table
pander(style_table1(pa_tab_sex_ex), missing = "-")
...
# Output table
pander(style_table1(pa_tab_maturity_ex), missing = "-")
